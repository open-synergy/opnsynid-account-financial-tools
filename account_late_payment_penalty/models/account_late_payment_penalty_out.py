...
class AccountOutLatePaymentPenalty(models.Model):
    _name = "account.out_late_payment_penalty"
    _inherit = "account.common_late_payment_penalty"
    _description = "Out Late Payment Penalty Type"
    ...
    def _compute_direction(self):
        _super = super(AccountOutLatePaymentPenalty, self)
