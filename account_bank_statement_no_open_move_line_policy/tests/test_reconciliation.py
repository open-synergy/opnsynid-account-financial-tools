...
class TestReconcilation(TransactionCase):
    ...
    def test_reconciliation_bank(self):
        ...
        self.data_journal.allowed_group_bank_ids =\
            [(6, 0, self.group.ids)]
    ...
    def test_reconciliation_cash(self):
        ...
        # Insert Group to Account Jounal
        self.data_journal_cash.allowed_group_cash_ids =\
            [(6, 0, self.group.ids)]
    ...
    def test_reconciliation_no_bankcash(self):
        ...
        # Insert Group to Account Jounal
        self.data_journal_no_bankcash.allowed_group_cash_ids =\
            [(6, 0, self.group.ids)]
