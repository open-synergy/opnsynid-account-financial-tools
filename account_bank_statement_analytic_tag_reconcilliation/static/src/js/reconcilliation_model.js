...
*/
/* eslint no-unused-vars: "off", no-param-reassign: "off", radix: "off" */
odoo.define(
    "account_bank_statement_analytic_tag_reconcilliation.ReconciliationModel",
    function (require) {
        "use strict";
        ...
        ReconciliationModel.StatementModel.include({
            ...
            quickCreateProposition: function (handle, reconcileModelId) {
                ...
                var focus = this._formatQuickCreate(
                    line,
            ...
            _formatQuickCreate: function (line, values) {
                ...
                result.analytic_tag_ids = this._formatMany2ManyTags(
